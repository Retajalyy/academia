...
class CardDetailsForm extends StatelessWidget {
  ...
  // ── Field fill / border customization 
  ...
  const CardDetailsForm({
    ...
    // Hint strings
    this.cardNumberHint = '1234 1234 1234 1234',
      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              // Card Number
              _field(cardNumberLabel, cardNumberHint),
              const SizedBox(height: 10),

              // Expiry Date + CVV side by side
              Row(
                children: [
                  Expanded(child: _field(expiryLabel, expiryHint)),
                  const SizedBox(width: 10),
                  Expanded(child: _field(cvvLabel, cvvHint)),
                ],
              ),
              const SizedBox(height: 10),

              // Name on Card
              _field(nameLabel, nameHint),
            ],
          ),
        ),
      ],
